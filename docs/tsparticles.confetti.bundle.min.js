...
!function (t, e) {
    ...
    function It(t, e, i = !0) {
        ...
        if (wt(s.value))
            return s.value === Mt ? Vt() : Ft(s.value);
        if (zt(s.value))
            return It({
                value: K(s.value, e, i)
            });
    ...
    function Ht(t, e, i) {
            ...
            return i;
        {
            ...
            if (i && s && e)
                return qt(i, s, t.getRadius(), e.getRadius());
            {
                const t = i ?? s;
                if (t)
                    return At(t)
    ...
    function Yt(t, e, i) {
        t.enable = e.enable,
            t.enable ? (t.velocity = C(e.speed) / 100 * i,
                t.decay = 1 - C(e.decay),
                t.status = "increasing",
                t.loops = 0,
    ...
    function Kt(t) {
        const { container: e, context: i, particle: s, delta: o, colorStyles: n, backgroundMask: a, composite: r, radius: l, opacity: c, shadow: h, transform: d } = t
            , u = s.getPosition()
        ...
        h.enable && v && (i.shadowBlur = h.blur,
            i.shadowColor = Ut(v),
    ...
    class Ce {
        ...
        load(t) {
            t && (void 0 !== t.count && (this.count = T(t.count)),
                void 0 !== t.enable && (this.enable = t.enable),
    ...
    class Re {
        ...
        load(t) {
            t && (yt(t.random) ? this.random.enable = t.random : this.random.load(t.random),
                void 0 !== t.value && (this.value = T(t.value, this.random.enable ? this.random.minimumValue : void 0)))
        }
    }
    class Le extends Re {
        constructor() {
    ...
    class Ue {
        ...
        load(t) {
            t && (void 0 !== t.offset && (this.offset = T(t.offset)),
    ...
    class He {
        ...
        load(t) {
            t && (void 0 !== t.acceleration && (this.acceleration = T(t.acceleration)),
                void 0 !== t.enable && (this.enable = t.enable),
    ...
    class Qe extends Re {
        ...
        load(t) {
            ...
            const e = t.animation ?? t.anim;
            void 0 !== e && (this.animation.load(e),
                this.value = T(this.value, this.animation.enable ? this.animation.minimumValue : void 0))
        }
    }
    class Je {
        constructor() {
    ...
    class hi {
        ...
        load(t) {
            t && (void 0 !== t.color && (this.color = ke.create(this.color, t.color)),
    ...
    class yi {
        constructor(t, e, i, s, o, n) {
            this.container = i,
                ...
                this._calculateVelocity = () => {
                    ...
                    return e.straight || (t.angle += P(T(o.left, o.right))),
        ...
        init(t, e, i, s) {
            ...
            this.shapeData = this._loadShapeData(d, h),
                l.load(i);
            ...
            g || (g = this._engine.plugins.getShapeDrawer(this.shape),
    ...
    class zi {
            ...
            this.rectangle = t,
                ...
                this._subdivide = () => {
                    const { x: t, y: e } = this.rectangle.position
                        ...
                        , { capacity: o } = this;
                    for (let n = 0; n < 4; n++)
                        this._subs.push(new zi(new xi(t + i / 2 * (n % 2), e + s / 2 * (Math.round(n / 2) - n % 2), i / 2, s / 2), o));
                    this._divided = !0
                }
                ,
                this._points = [],
        ...
        query(t, e, i) {
            ...
            for (const i of this._points)
                !t.contains(i.position) && D(t.position, i.position) > i.particle.getRadius() && (!e || e(i.particle)) || s.push(i.particle);
            if (this._divided)
    ...
    class Pi {
        ...
        addManualParticles() {
            ...
            for (const i of e.manualParticles)
                this.addParticle(i.position ? gt(i.position, t.canvas.size) : void 0, i.options)
        }
        addParticle(t, e, i, s) {
    ...
    class Oi {
        ...
        addPath(t, e, i = !1) {
            return !(!Si(this) || !i && this.pathGenerators.has(t)) && (this.pathGenerators.set(t, e ?? Ti),
                !0)
        }
        alive() {
        ...
        async init() {
            ...
            this._options = ki(this._engine, this, this._initialSourceOptions, this.sourceOptions),
        ...
        async loadTheme(t) {
            Si(this) && (this._currentTheme = t,
                await this.refresh())
        }
        pause() {
            if (Si(this) && (void 0 !== this._drawAnimationFrame && (cancelAnimationFrame(this._drawAnimationFrame),
        ...
        async start() {
            Si(this) && !this.started && (await this.init(),
                this.started = !0,
                await new Promise((t => {
    ...
    class Ri {
        ...
        async set(t, e, i, s) {
            ...
            return wt(t) ? o.id = t : o.element = t,
        ...
        async _loadParams(t) {
            const e = t.id ?? `tsparticles ${Math.floor(1e4 * _())}`
                ...
                , n = o ? await async function (t) {
                    ...
                    return i.ok ? i.json() : (W().error(`${f} ${i.status} while retrieving config file`),
                        t.fallback)
                }({
                    fallback: t.options,
                    url: o,
            ...
            if ("canvas" === a.tagName.toLowerCase())
                ...
                t.length ? (h = t[0],
                    h.dataset[i] = "false") : (h = document.createElement("canvas"),
                        h.dataset[i] = "true",
                        a.appendChild(h))
            }
            ...
            return c >= 0 ? l.splice(c, 0, d) : l.push(d),
    ...
    class Ui {
        ...
        load(t) {
            ...
            const s = t.position;
            s && (void 0 !== s.x && (this.position.x = s.x),
    ...
    function $i(t, e, i, s, o, n) {
        !function (t, e) {
            ...
            s.clamp && (t.velocity.x = z(t.velocity.x, -1, 1),
        ...
        a?.enable && s > 0 && (!a.inverse && c.y >= 0 && c.y >= s || a.inverse && c.y <= 0 && c.y <= -s) && (c.y = r * s,
            i && (t.velocity.y = c.y / i));
        const h = t.options.zIndex
            , d = (1 - t.zIndexFactor) ** h.velocityRate;
        c.multTo(d);
        const { position: u } = t;
        u.addTo(c),
            e.vibrate && (u.x += Math.sin(u.x * Math.cos(u.y)),
                    ...
                    if (r || l)
                        if ((r && o >= r || l && n >= l) && !t.misplaced)
                            ...
                            r && (i.x < e.x && s.x < 0 || i.x > e.x && s.x > 0) && (s.x *= -_()),
                                l && (i.y < e.y && s.y < 0 || i.y > e.y && s.y > 0) && (s.y *= -_())
                        }
                }(t)
        }
    }
    ...
    function Wi(t, e, i, s, o) {
        ...
        const n = P(i.offset)
            ...
            , r = e.decay ?? 1;
        o && "increasing" !== e.status ? (e.value -= a,
            e.value < 0 && (e.loops || (e.loops = 0),
                e.loops++,
                e.status = "increasing",
                e.value += e.value)) : (e.value += a,
    ...
    class Xi {
        ...
        init(t) {
            ...
            t.opacity = ft(e, 1);
            const i = e.animation;
            i.enable && (t.opacity.velocity = C(i.speed) / 100 * this.container.retina.reduceFactor,
                        ...
                        case "normal":
                            {
                                const i = t.options.move.warp
                                    ...
                                    , a = t.getRadius()
                                    , r = it(t.position, a);
                                "right" === e && r.left > s.width + t.offset.x ? (t.position.x = n.left,
                                    t.initialPosition.x = t.position.x,
                                    i || (t.position.y = _() * s.height,
                                        t.initialPosition.y = t.position.y)) : "left" === e && r.right < -t.offset.x && (t.position.x = n.right,
                                            t.initialPosition.x = t.position.x,
                                            i || (t.position.y = _() * s.height,
                                                t.initialPosition.y = t.position.y)),
                                    "bottom" === e && r.top > s.height + t.offset.y ? (i || (t.position.x = _() * s.width,
                                        t.initialPosition.x = t.position.x),
                                        t.position.y = n.top,
                                        t.initialPosition.y = t.position.y) : "top" === e && r.bottom < -t.offset.y && (i || (t.position.x = _() * s.width,
                                            t.initialPosition.x = t.position.x),
    ...
    class rs {
        randomPosition(t, e, i) {
            const [s, o] = [e.width / 2, e.height / 2]
                ...
                , a = (h = n,
                    (l = s) * (c = o) / Math.sqrt((c * Math.cos(h)) ** 2 + (l * Math.sin(h)) ** 2))
                , r = i ? a * Math.sqrt(_()) : a;
            var l, c, h;
            return {
                x: t.x + r * Math.cos(n),
    ...
    class cs {
        ...
        load(t) {
            void 0 !== t && (void 0 !== t.quantity && (this.quantity = T(t.quantity)),
                void 0 !== t.delay && (this.delay = T(t.delay)))
        }
    }
    class hs {
    ...
    class ds {
        ...
        load(t) {
            t && (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
                void 0 !== t.size && (this.size || (this.size = new hs),
                    this.size.load(t.size)),
                void 0 !== t.direction && (this.direction = t.direction),
                this.domId = t.domId,
                void 0 !== t.fill && (this.fill = t.fill),
                ...
                void 0 !== t.spawnColor && (void 0 === this.spawnColor && (this.spawnColor = new ke),
    ...
    class us {
        constructor(t, e, i, s, o) {
            this.emitters = e,
                ...
                s instanceof ds ? this.options = s : (this.options = new ds,
                    this.options.load(s)),
                this._spawnDelay = 1e3 * C(this.options.life.delay ?? 0) / this.container.retina.reduceFactor,
                ...
                void 0 !== this._duration && (this._currentDuration += t.value,
                    this._currentDuration >= this._duration && (this.pause(),
                        ...
                        this._lifeCount > 0 || this._immortal ? (this.position = this._calcPosition(),
                            this._spawnDelay = 1e3 * C(this.options.life.delay ?? 0) / this.container.retina.reduceFactor) : this._destroy(),
        ...
        switch (t.nextByte()) {
            ...
            case 44:
                await async function (t, e, i, s, o, n) {
                    ...
                    const d = t => {
                        const { r: s, g: n, b: r } = (l ? a.localColorTable : e.globalColorTable)[t];
                        return {
                            r: s,
                            g: n,
                            b: r,
                                ...
                                for (let t = 0, e = 0; ;) {
                                    ...
                                    if (i = g(r, o),
                                        ...
                                        for (let s = 0; s < l[i].length; s++) {
                                            ...
                                            u.data.set([o, n, r, h], bs[c] * a.width + xs[c] * e + t % (4 * a.width)),
                                                t += 4
                                        }
                                        l.length === 1 << o && o < 12 && o++
                                    }
                                    if (t === 4 * a.width * (e + 1) && (e++,
                                        bs[c] + xs[c] * e >= a.height))
                                        break
                                }
    ...
    async function ks(t) {
        if ("svg" !== t.type)
            return void await Cs(t);
        t.loading = !0;
        const e = await fetch(t.source);
        e.ok ? t.svgData = await e.text() : (W().error(`${f} Image not found`),
            t.error = !0),
            t.loading = !1
    }
    function Ts(t, e, i, s) {
    ...
    class Ys {
        ...
        load(t) {
            t && (void 0 !== t.backColor && (this.backColor = ce.create(this.backColor, t.backColor)),
    ...
    class Qs {
        ...
        init(t) {
            ...
            const s = e.animation;
            s.enable && (t.rotate.decay = 1 - C(s.decay),
                t.rotate.velocity = C(s.speed) / 360 * this.container.retina.reduceFactor,
    ...
    class io {
        ...
        particleInit(t, e) {
            if (!e.shape || !eo.includes(e.shape))
                return;
            const i = e.shapeData;
            if (void 0 === i)
                return;
    ...
    class no {
        ...
        init(t) {
            ...
            s?.enable && (t.tilt.decay = 1 - C(s.decay),
                t.tilt.velocity = C(s.speed) / 360 * this.container.retina.reduceFactor,
    ...
    class ao {
        ...
        load(t) {
            t && (void 0 !== t.angle && (this.angle = T(t.angle)),
    ...
    class ro {
        ...
        load(t) {
            if (t && (void 0 !== t.distance && (this.distance = T(t.distance)),
                void 0 !== t.enable && (this.enable = t.enable),
                void 0 !== t.speed))
                if (bt(t.speed))
                    this.speed.load({
